...
#include "ui_donutchart.h"

using namespace QtCharts;

DonutChart::DonutChart(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::DonutChart)
{
    ui->setupUi(this);
}
...
void DonutChart::on_draw_clicked()
{
    // 4. Pie Chart Example
...
//    slice4->setLabelVisible();
    ...
    donutchartdisplay = new DonutChartDisplay(this, chartView);
    donutchartdisplay->show();
}
